...
export default function JobDescriptionInput({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Toggle Tabs */}
      <div className="flex space-x-2 bg-gray-100 rounded-lg p-1 mb-6 shadow-inner">
        <button
          type="button"
          onClick={() => {
            onInputTypeChange("file");
          ...
          className={`flex-1 py-3 px-4 cursor-pointer rounded-md text-sm font-medium transition-all duration-200 ${
            inputType === "file"
      ...
      {inputType === "text" ? (
        <div className="space-y-3">
          <textarea
            ...
            placeholder="Paste the job description here..."
            rows={8}
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none text-sm text-gray-800 placeholder-gray-500 shadow-sm"
          />
        </div>
      ) : (
        <div className="space-y-3">
          <div
            className={`relative border-2 border-dashed rounded-2xl p-8 transition-all duration-300 cursor-pointer shadow-sm ${
              file
            ...
            <div className="text-center">
              {file ? (
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-500 text-xs">Supports PDF, DOC, DOCX files</p>
                </div>
              )}
            </div>
          </div>
